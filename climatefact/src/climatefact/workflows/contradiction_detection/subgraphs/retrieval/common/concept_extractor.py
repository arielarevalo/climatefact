...
class ConceptExtractor:
    ...
    def _map_nltk_entity_type(self, nltk_label: Optional[str]) -> Optional[str]:
...
class ConceptIndexQuerier:
    ...
    def query_text(self, text: str, use_hybrid: bool = True) -> Dict[str, Any]:
        ...
        for concept in extracted_concepts:
            ...
            if concept_type in index_to_use:
                ...
                for indexed_concept in type_concepts.keys():
    ...
    def get_concept_sentences(self, concept_text: str, concept_type: Optional[str] = None, use_hybrid: bool = True) -> List[str]:
        """
