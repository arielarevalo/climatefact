...
from metrics.nli_metrics import NLIMetrics
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/ariel/workspace/ci0129/proyecto/climatefact/evals/logs/nli_evaluation.log'),
...
class FullNLIEvaluationRunner:
    ...
    def __init__(self, base_data_path: str = "/Users/ariel/workspace/ci0129/proyecto/data"):
        self.base_data_path = base_data_path
        self.gold_set_path = f"{base_data_path}/evaluation/gold_set.jsonl"
        self.passages_path = f"{base_data_path}/passages.jsonl"
        
        # Create output directories
        self.reports_dir = Path("/Users/ariel/workspace/ci0129/proyecto/climatefact/evals/reports")
        self.logs_dir = Path("/Users/ariel/workspace/ci0129/proyecto/climatefact/evals/logs")
    ...
    def verify_data_files(self) -> bool:
        ...
        """
        required_files = [
            (self.gold_set_path, "Gold set file"),
            (self.passages_path, "Passages file")
        ]
    ...
    def run_full_evaluation(self, max_queries: Optional[int] = None) -> Dict[str, Any]:
        """
...
"""
            ...
            if worst_class and worst_f1 < 0.3:
                report_content += f"\n- {worst_class} class performs poorly (F1={worst_f1:.3f}). Consider class-specific improvements."
...
"""
            ...
            raise RuntimeError(f"Failed to generate comprehensive report: {e}")
    ...
    def save_results_json(self, results: Dict[str, Any]) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to save results JSON: {e}")
