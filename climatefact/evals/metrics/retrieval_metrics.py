...
class RetrievalMetrics:
    ...
    def evaluate_multiple_queries(self, 
                                queries_results: List[Tuple[List[Dict[str, Any]], str]],
                                k_values: List[int] = [1, 3, 5, 10]) -> Dict[str, Dict[str, float]]:
        """
        ...
        for k in k_values:
            ...
            averaged_results[k_key] = {
                metric: sums[metric] / num_queries for metric in sums
            }
    ...
    def compare_retrieval_methods(self, 
                                method_results: Dict[str, Dict[str, Dict[str, float]]]) -> Dict[str, Any]:
        """
        ...
        for k in k_values:
            ...
            for metric in metrics:
                ...
                if method_scores:
                    ...
                    comparison["best_methods"][k][metric] = {
                        "method": best_method[0],
                        "score": best_method[1]
                    }
        
        # Overall performance summary
        method_wins = {method: 0 for method in method_results.keys()}
        total_comparisons = 0
    ...
    def _evaluate_control_case(self, 
                             retrieved_passages: List[Dict[str, Any]], 
                             k_values: List[int] = [1, 3, 5, 10]) -> Dict[str, Dict[str, float]]:
        """
        ...
        for k in k_values:
            ...
            if num_retrieved == 0:
                # Perfect control case - no results returned as expected
                perfect_score = 1.0
            else:
                # Failed control case - results were returned when none should have been
                perfect_score = 0.0
