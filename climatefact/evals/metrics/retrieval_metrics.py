...
class RetrievalMetrics:
    ...
    def evaluate_single_query(
        self, retrieved_passages: list[dict[str, Any]], relevant_passage_id: str, k_values: list[int] = [1, 3, 5, 10]
    ...
    def evaluate_multiple_queries(
        self, queries_results: list[tuple[list[dict[str, Any]], str]], k_values: list[int] = [1, 3, 5, 10]
    ) -> dict[str, dict[str, float]]:
        """
    ...
    def _evaluate_control_case(
        self, retrieved_passages: list[dict[str, Any]], k_values: list[int] = [1, 3, 5, 10]
    ) -> dict[str, dict[str, float]]:
        """
