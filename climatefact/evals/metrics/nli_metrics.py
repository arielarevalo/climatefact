...
class NLIMetrics:
    ...
    def calculate_precision_recall_f1(
        ...
        # Calculate TP, FP, FN
        tp = sum(1 for p, t in zip(pred_normalized, true_normalized) if p == target_label and t == target_label)
        fp = sum(1 for p, t in zip(pred_normalized, true_normalized) if p == target_label and t != target_label)
        fn = sum(1 for p, t in zip(pred_normalized, true_normalized) if p != target_label and t == target_label)
