...
Como fuente de conocimiento se utilizó el informe de síntesis del Sexto Informe de Evaluación del IPCC~\cite{ipcc2023}, en formato PDF. Para preservar la estructura semántica original, se aplicó el parser \texttt{MinerU}, que permite transformar documentos a Markdown con etiquetas estructurales. De esta forma se descartaron las imágenes y los pies de página para lograr obtener un corpus más limpio.
