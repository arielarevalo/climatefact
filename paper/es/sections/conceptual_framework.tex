...
La verificación automática de hechos requiere fuentes confiables. El corpus empleado corresponde al \textbf{informe de síntesis del Sexto Informe del IPCC} \cite{ipcc2023}, que proporciona información técnica validada sobre el cambio climático. Utilizar un corpus con estructura científica garantiza coherencia y confiabilidad en las inferencias.
