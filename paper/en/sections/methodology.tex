...
Fig.~\ref{fig:kb-construction} summarizes the offline knowledge base construction pipeline described in the preceding subsections. Its two output artifacts---the passage embeddings and the concept index---serve as the data stores consumed at query time.
