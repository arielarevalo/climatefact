...
Automatic fact-checking requires reliable sources. The corpus used corresponds to the \textbf{Synthesis Report of the Sixth Assessment Report of the IPCC} \cite{ipcc2022}, which provides validated technical information on climate change. Using a corpus with a scientific structure ensures coherence and reliability in the inferences.
